...
class SdrArray(ABC):
    ...
    def sparse_distributed_representation(self, *args) -> sdr_sparse_t:
        """Get the sparse representation of this SDR."""

        self.__dimensions = args[0] if args else self.__dimensions
        return self._sparse
